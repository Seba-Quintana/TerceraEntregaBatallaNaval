...
/// </summary>
[System.Serializable]
public class CuentaYaExistenteException : System.Exception
{
    /// <summary>
    ...
    /// Constructor default
    /// </summary>
    public CuentaYaExistenteException() { }
    ...
    /// <returns></returns>
    public CuentaYaExistenteException(string message) : base(message) { }
    ...
    /// <returns></returns>
    public CuentaYaExistenteException(string message, System.Exception inner) : base(message, inner) { }
    ...
    /// <returns></returns>
    public CuentaYaExistenteException(string message, int numerodejugador) : this(message)
    {
