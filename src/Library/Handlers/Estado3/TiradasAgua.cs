...
{
    /// <summary>
    /// Un "handler" del patrón Chain of Responsibility que implementa el comando "TiradasAgua".
    /// </summary>
    public class TiradasAguaHandler : BaseHandler
    {
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="BaseHandler"/>. Esta clase procesa el mensaje "Remover".
        /// </summary>
        /// <param name="next">El próximo "handler".</param>
        public TiradasAguaHandler(BaseHandler next) : base(next)
        {
            this.Keywords = new string[] {"/TiradasAgua"};
        }
        ...
        protected override bool InternalHandle(Message mensaje, out string respuesta)
        {
            try
            {
                ...
                if (this.CanHandle(mensaje))
                {
                    ...
                    int tiradasAgua = Planificador.TiradasAguaTotales(jugadorActual);
                    string respuestaTiradasAgua = tiradasAgua.ToString();

                    respuesta += $"la cantidad de tiradas totales en agua es de: {respuestaTiradasAgua}.\n";
