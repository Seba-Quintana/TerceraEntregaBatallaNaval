    ...
    public class DisparosBarcoHandler : BaseHandler
    {
        ...
        protected override bool InternalHandle(Message mensaje, out string respuesta)
        {
            if (this.CanHandle(mensaje))
            {
                ...
                int numeroDeJugador = Planificador.ConversorIDaNum(mensaje.Chat.Id);
                respuesta = $"Esta es la cantidad de disparos que han efectuado ambos jugadores a algun barco {Planificador.CantidadDeDisparosABarcos(numeroDeJugador)}";
