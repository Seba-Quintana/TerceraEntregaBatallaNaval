...
namespace ClassLibrary
{
    ...
    /// </summary>
    public class VerTiradasAguaHandler : BaseHandler
    {
        /// <summary>
        /// Inicializa una nueva instancia de la clase <see cref="BaseHandler"/>. Esta clase procesa el mensaje "VerHistorial".
        /// </summary>
        /// <param name="next">El próximo "handler".</param>
        public VerTiradasAguaHandler(BaseHandler next) : base(next)
        {
            this.Keywords = new string[] {"/VerAtaquesAlAgua"};
        }
        ...
        protected override bool InternalHandle(Message mensaje, out string respuesta)
        {
            try
            {
                ...
                if (this.CanHandle(mensaje))
                {
                    ...
                    respuesta += $"La cantidad de tiradas al agua hasta el momento es: {Planificador.VerAtaquesAlAgua(numdelJugador)}\n";
                    return true;
                }
                return false;
            }
