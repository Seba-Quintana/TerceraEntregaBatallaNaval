...
namespace ConsoleApplication
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            tercerHandler = new PosicionarHandler(new RendirseHandler(new DisparosAguaHandler(new DisparosBarcoHandler(null))));

            cuartoHandler = new AtacarHandler(new RendirseHandler(new DisparosAguaHandler(new DisparosBarcoHandler(null))));
